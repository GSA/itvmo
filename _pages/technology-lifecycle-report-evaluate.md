...
permalink: /technology-lifecycle-report-evaluate/
layout: page
sidenav: false
---
...
<div class="usa-accordion">
      ...
      <h3 class="usa-accordion__heading">
        <button class="usa-accordion__button" aria-expanded="true" aria-controls="b-a1" id="evaluate">
          Evaluate and Assess
        </button>
      </h3>
        ...
        <div class="grid-row flex-align-center">
            ...
            <div class="tablet:grid-col-4 container">
              <div class="padding-x-2 radius-lg border-05 border-primary-lighter">
                  ...
                  <p><b><em>NEW: </em></b><a href="{{site.baseurl}}/assets/files/tlr/A-Guide-to-Finding-Security-Related-Obligations.pdf">How do I find CyberSecurity related obligations?</a></p>
              </div>
            </div>
        </div>
      ...
      <h3 class="usa-accordion__heading">
        <button class="usa-accordion__button" aria-expanded="false" id="procure" aria-controls="b-a2">
         Procure
        </button>
      </h3>
